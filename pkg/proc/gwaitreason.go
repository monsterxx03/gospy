...
var waitReason_1_20 = waitReasonMapping{
	0:  "",
	1:  "GC assist marking",
	2:  "IO wait",
	3:  "chan receive (nil chan)",
	...
	24: "trace reader (blocked)",
	25: "wait for GC cycle",
	26: "GC worker (idle)",
	27: "GC worker (active)",
	28: "preempted",
	29: "debug call",
	30: "GC mark termination",
	31: "stopping the world",
}

var waitReason_default = waitReason_1_20
...
var versionedWaitReason = map[string]waitReasonMapping{
	...
	"1.14": waitReason_1_13,
	"1.15": waitReason_1_13,
	"1.16": waitReason_1_13,
	"1.17": waitReason_1_13,
	"1.18": waitReason_1_13,
	"1.19": waitReason_1_13,
	"1.20": waitReason_1_20,
	"1.21": waitReason_1_20,
}
